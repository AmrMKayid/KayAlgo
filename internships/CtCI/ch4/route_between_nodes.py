...
class Test(unittest.TestCase):
  ...
  def test_find_route(self):
    ...
    self.assertEqual(str_for(route_between_nodes(node_a, node_i)), 'None')
    self.assertEqual(str_for(route_between_nodes(node_a, node_j)), 'ABJ')
    node_h.add_edge_to(node_i)
    self.assertEqual(str_for(route_between_nodes(node_a, node_i)), 'ACGHI')
